...
public class Site {
    ...
    public Site setTags(String tags) {
        this.tags = tags;
        return this;
    }
    ...
    public Site setMobilePage(boolean mobilePage) {
    ...
    public Site setTargetUrls(List<String> targetUrls) {
    ...
    public Site setHelpUrls(List<String> helpUrls) {
    ...
    public Site setExcludeUrls(List<String> excludeUrls) {
    ...
    public Site setMaxDepth(int maxDepth) {
        if (maxDepth < 0) {
